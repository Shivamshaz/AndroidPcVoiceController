						...
						if(flag==0)
							{
								...
								if(s1.equalsIgnoreCase(s21)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\metallica.mp4\"")}
								if(s1.equalsIgnoreCase(s22)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\bad day.flv\"")}
								if(s1.equalsIgnoreCase(s23)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\Good feeling.flv\"")}
								if(s1.equalsIgnoreCase(s24)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\awesome dj.flv\"")}
								if(s1.equalsIgnoreCase(s25)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\limitless.mp4\"")}
								if(s1.equalsIgnoreCase(s26)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\wild ones.flv\"")}
								if(s1.equalsIgnoreCase(s27)){Runtime.getRuntime().exec("C:\\Program Files (x86)\\VideoLAN\\VLC\\vlc.exe \"E:\\video\\world.flv\"")}
